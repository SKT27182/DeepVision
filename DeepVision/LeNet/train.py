...
def load_model(args):
    if args.model == "LeNet_5_exact":
        model = LeNet().lenet_5_exact(input_shape=(32, 32, 1), classes=10)
    elif args.model == "LeNet_5_mod_1":
        model = LeNet().lenet_5_mod_1(input_shape=(32, 32, 1), classes=10)
    elif args.model == "LeNet_5_mod_2":
        model = LeNet().lenet_5_mod_2(input_shape=(28, 28, 1), classes=10)
...
def arg_parse():
    ...
    args.add_argument(
        "--summary", type=bool, default=False, help="Whether to print model summary or not"
    )
